...
<!-- paragraphs-item--content_audio_3_columns.tpl.php -->
<!-- Begin - paragraphs item -->
<div class="<?php print $classes; ?> os2-paragraphs-item-content os2-paragraphs-item-content-audio-3-columns"<?php print $attributes; ?>>
